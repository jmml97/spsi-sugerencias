...
\begin{sol}
  ...
  \begin{enumerate}
    ...
    \item El exponente $d$ debe ser elevado, y ésta es la razón de comenzar eligiéndolo para luego determinar $e$. Así se evita que sea encontrado mediante procedimientos de prueba y error.
...
Cuando Bob recibe el mensaje de Alice obtiene una pareja de números $c = \langle c_1, c_2 \rangle$ menores que $p$. Para descifrarlo hace lo siguiente:
