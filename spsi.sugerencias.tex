...
\begin{sol}
  ...
  \begin{displayquote}
    Si \(G = \langle g \rangle\) es un grupo y se conocen los valores $g^x$ y $g^y$, encuentra el valor de $g^{xy}$.
  \end{displayquote}
  ...
  Hasta ahora no se ha encontrado ningún algoritmo que resuelva el problema del logaritmo discreto en tiempo polinómico, y es de hecho considerado intratable computacionalmente.
