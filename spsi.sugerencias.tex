...
\end{equation}
donde $c_i$ es el $i$-ésimo bit del byte \{63\} ó \{01100011\} para todo $0 \leq i < 8$. 
\item Por ultimo, se toman los bits del menos significativo al mas significativo $b'_0\hdots b'_7$ (Se le da la vuelta a la palabra).El byte $b' = b'_0\cdots b'_7$ resultante ocupará la posición $(x,y)$ de la tabla (expresado en hexadecimal).
