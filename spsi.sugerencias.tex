...
\begin{sol}
  SSH (del inglés \textit{Secure SHell}) es un protocolo seguro utilizado principalmente para conectarse a un servidor de forma remota. Explicamos a continuación sus rasgos esenciales.
